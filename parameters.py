...
def args_parser():
    ...
    # Federated params
    parser.add_argument('--mode', type=str, default='hybrid', help='hybrid or topk')
    parser.add_argument('--gamma', type=float, default=0.95, help='freq value')
    ...
    parser.add_argument('--biasFair', type=bool, default=False, help='enable bias Fairness for sparsing ')
    parser.add_argument('--wd', type=float, default=1e-4, help='weight decay Value')
    parser.add_argument('--sparsity', type=int, default=256, help='/ sparsing ')
    parser.add_argument('--C_rand', type=int, default=4, help='/ sparsing ')
